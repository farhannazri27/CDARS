 ...
 *       &lt;sequence>
 *         &lt;element name="InsertUserResult" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InsertUserResponse {
    ...
    @XmlElement(name = "InsertUserResult")
    protected int insertUserResult;

    /**
     * Gets the value of the insertUserResult property.
     * 
     */
    public int getInsertUserResult() {
     ...
     * 
     */
    public void setInsertUserResult(int value) {
