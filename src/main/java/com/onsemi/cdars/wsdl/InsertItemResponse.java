 ...
 *       &lt;sequence>
 *         &lt;element name="InsertItemResult" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InsertItemResponse {
    ...
    @XmlElement(name = "InsertItemResult")
    protected int insertItemResult;

    /**
     * Gets the value of the insertItemResult property.
     * 
     */
    public int getInsertItemResult() {
     ...
     * 
     */
    public void setInsertItemResult(int value) {
