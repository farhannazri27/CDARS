...
public class DhRequestController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DhRequestController.class);
    String[] args = {};
...
//    private static final String HEADER = "id,hardware_type,hardware_id,quantity,material pass number,material pass expiry date,inventory location,requested_by,requested_email,requested_date,remarks";
    ...
    @RequestMapping(value = "/dhRequest", method = RequestMethod.GET)
...
//        List<WhRequest> whRequestList = whRequestDAO.getWhRequestListWithoutRetrievalAndStatusApproved();
        ...
        return "dhRequest/dhRequest";
    }

    @RequestMapping(value = "/dhRequest/request", method = RequestMethod.GET)
    public String request(Model model) {
        ParameterDetailsDAO sDAO = new ParameterDetailsDAO();
        List<ParameterDetails> requestType = sDAO.getGroupParameterDetailList("", "019");
        ...
        return "dhRequest/request";
    }

    @RequestMapping(value = "/dhRequest/add", method = RequestMethod.GET)
    public String add(Model model,
        ...
        } else if ("Sg Gadut".equals(requestType)) {
        ...
        return "dhRequest/add";
    }

    @RequestMapping(value = "/dhRequest/save", method = RequestMethod.POST)
    public String save(
            Model model,
