            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Email List for RC/CA</h2>

                            <div class="filter-block pull-right">
                                <a href="${contextPath}/whTimelapse/emailTimelapseRcCa/add" class="btn btn-primary pull-right">
                                ...
                                <tbody>
                                    <c:forEach items="${emailTimelapseList}" var="emailConfig" varStatus="emailConfigtLoop">
                                        <tr>
                                            ...
                                            <td><c:out value="${emailConfig.sendCc}"/></td>
                                            <td><c:out value="${emailConfig.userName}"/></td>
                                            <td id="modal_delete_info_${emailConfig.id}"><c:out value="${emailConfig.email}"/></td>
                                            <td align="center">
                                                <a href="${contextPath}/whTimelapse/emailTimelapseRcCa/edit/${emailConfig.id}" class="table-link" title="Edit">
                                                    <span class="fa-stack">
    ...
    <s:layout-component name="page_js_inline">
        <script>
                                                        ...
                                                        function modalDelete(e) {
                                                            ...
                                                            var deleteUrl = "${contextPath}/whTimelapse/emailTimelapseRcCa/delete/" + deleteId;
