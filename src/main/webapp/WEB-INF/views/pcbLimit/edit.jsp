            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="edit_limit_form" class="form-horizontal" role="form" action="${contextPath}/admin/pcbLimit/update" method="post">
                            <input type="hidden" name="id" value="${pcbLimit.id}" />
