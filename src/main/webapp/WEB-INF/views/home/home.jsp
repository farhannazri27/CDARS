...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_header">
        <f:message key="general.label.dashboard"/> - ${sessionScope.userSession.fullname}
    </s:layout-component>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-box clearfix">
                            ...
                            <hr/>
                            <p>Sorry, your ID is not registered with CDARS, please contact our System Administrator for further help!</p>
                        </div>
                    </div>
                </div>
            </c:if>
