                                    ...
                                    <c:forEach items="${itemList}" var="item" varStatus="itemLoop">
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a modaldeleteid="${item.PKID}" data-toggle="modal" href="#delete_modal" class="table-link danger group_delete" onclick="modalDelete(this);">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
    ...
    <s:layout-component name="page_js_inline">
        <script>
            ...
            function modalDelete(e) {
                ...
                var deleteUrl = "${contextPath}/hardwarequeue/delete/" + deleteId;
