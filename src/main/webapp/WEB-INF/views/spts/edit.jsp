...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Edit Item</h1>
            <form id="edit_item_form" class="form-horizontal" role="form" action="${contextPath}/spts/update" method="post">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="main-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="prodQty" name="prodQty" placeholder="Production Quantity" value="${item.ProductionQty}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <c:set var="formattedDate" value="${fn:substring(item.ExpirationDate, 0, 10)}" />
                                        <input type="text" name="expirationDate" class="form-control" id="datepickerDate" value="${formattedDate}">
                                    </div>
    ...
    <s:layout-component name="page_js_inline">
        <script>
            $(document).ready(function () {
                ...
                $('#rack').val("<c:out value="${item.Rack}"/>");
                $('#isCritical').val("<c:out value="${item.IsCritical}"/>");
                $('#isConsumeable').val("<c:out value="${item.IsConsumeable}"/>");
                $('#itemType').val("<c:out value="${item.ItemType}"/>");
                $('#cardType').val("<c:out value="${item.CardType}"/>");
                ...
                var validator = $("#edit_item_form").validate({
                    rules: {
                        itemID: {
                            required: true
                        },
