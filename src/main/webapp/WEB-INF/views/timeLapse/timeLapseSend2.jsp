...
<!--        <link rel="stylesheet" href="${contextPath}/resources/private/datatables/css/jquery.dataTables.css" type="text/css" />
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Time Lapse - With RC and CA</h1>
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        ...
                        <div class="filter-block pull-left">
                            <a href="${contextPath}/whTimelapse/send" class="btn btn-primary pull-right">
                                ...
                                <tbody>
                                    <c:forEach items="${surrogate}" var="whInventory" varStatus="whInventoryLoop">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <a href="${contextPath}/whTimelapse/manageSend2/${whInventory.requestId}" class="table-link" title="Manage">
                                                    <span class="fa-stack">
