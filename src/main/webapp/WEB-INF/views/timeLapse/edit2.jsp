            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/whTimelapse/update2" method="post">
                            <input type="hidden" name="id" value="${whStatusLog.requestId}" />
                            <input type="hidden" name="requestType" value="${requestType}" />
                             <input type="hidden" name="tiId" value="${whStatusLog.tiId}" />
                            ...
                            <div class="form-group" id="remarksdiv">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="3" id="remarks" name="remarks" readonly="">${whStatusLog.statusUsl}</textarea>
                                </div>
                            </div><br>
                            ...
                            <div class="form-group" id="remarksdiv">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="3" id="rootCause" name="rootCause">${whStatusLog.rootCause}</textarea>
                            ...
                            <div class="form-group" id="remarksdiv">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="3" id="ca" name="ca">${whStatusLog.ca}</textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
                            <c:if test="${requestType == 'send'}">
                                <a href="${contextPath}/whTimelapse/send2" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
                            </c:if>
                            <c:if test="${requestType == 'retrieve'}">
                                <a href="${contextPath}/whTimelapse/retrieve2" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
                            </c:if>
