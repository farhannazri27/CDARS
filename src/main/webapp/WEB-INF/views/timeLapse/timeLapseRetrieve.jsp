...
<!--        <link rel="stylesheet" href="${contextPath}/resources/private/datatables/css/jquery.dataTables.css" type="text/css" />
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Time Lapse - Pending RC/CA</h1>
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/whTimelapse/retrieve2" class="btn btn-primary pull-right">
                                    <i class="fa fa-forward"></i> Timelapse with RC/CA
                                </a>
                            </div>
                        </div>
                        <hr/>
                                ...
                                <tbody>
                                    <c:forEach items="${surrogate}" var="whInventory" varStatus="whInventoryLoop">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <a href="${contextPath}/whTimelapse/manage2/${whInventory.requestId}" class="table-link" title="Manage">
                                                    <span class="fa-stack">
