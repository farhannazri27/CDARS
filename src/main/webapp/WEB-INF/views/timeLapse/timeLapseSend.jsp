                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/whTimelapse/send2" class="btn btn-primary pull-right">
                                ...
                                <tbody>
                                    <c:forEach items="${surrogate}" var="whInventory" varStatus="whInventoryLoop">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <a href="${contextPath}/whTimelapse/manage1/${whInventory.requestId}" class="table-link" title="Manage">
                                                    <span class="fa-stack">
