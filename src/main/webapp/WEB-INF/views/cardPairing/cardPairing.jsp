...
<!--        <link rel="stylesheet" href="${contextPath}/resources/private/datatables/css/jquery.dataTables.css" type="text/css" />
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Warehouse Management - Card Pairing</h1>
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Card Pairing List</h2>

                            <div class="filter-block pull-right">
                                <a href="${contextPath}/admin/cardPairing/add" class="btn btn-primary pull-right">
                                    <i class="fa fa-plus-circle fa-lg"></i> Add New Pairing Card
                                </a>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="table-responsive">
                            <table id="dt_spml" class="table">
                                <thead>
                                    <tr>
                                        <th><span>No</span></th>
                                        <th><span>Single/Pair</span></th>
                                        <th><span>Pair Id</span></th> 
                                        <th><span>Load Card ID</span></th>
                                        <th><span>Program Card ID</span></th>
                                        <th><span>Manage</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${cardPairingList}" var="whRequest" varStatus="whRequestLoop">
                                        <tr>
                                            <td><c:out value="${whRequestLoop.index+1}"/></td>
                                            <td><c:out value="${whRequest.type}"/></td>
                                            <td id="modal_delete_info_${whRequest.id}"><c:out value="${whRequest.pairId}"/></td>
                                            <td><c:out value="${whRequest.loadCard}"/></td>
                                            <td><c:out value="${whRequest.programCard}"/></td>
                                            <td align="center">
                                                <a href="${contextPath}/admin/cardPairing/edit/${whRequest.id}" class="table-link" title="Edit">
                                                    <span class="fa-stack">
...
//                });
                                                        ...
                                                        function modalDelete(e) {
                                                            ...
                                                            var deleteUrl = "${contextPath}/admin/cardPairing/delete/" + deleteId;
