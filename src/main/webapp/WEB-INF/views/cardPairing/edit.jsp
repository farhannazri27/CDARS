            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/admin/cardPairing/update" method="post">
                            <div class="form-group">
                                <label for="pairId" class="col-lg-2 control-label">Pair ID </label>
                                <div class="col-lg-2">
                                    <input type="text" class="form-control" id="pairId" name="pairId" value="${cardPairing.pairId}" readonly>
                                </div>
                            </div> 
                            <div class="form-group">
                                <input type="hidden" name="id" value="${cardPairing.id}" />
    ...
    <s:layout-component name="page_js_inline">
        <script>
            $(document).ready(function () {
                ...
                $('#loadCard').val("<c:out value="${cardPairing.loadCard}"/>");
                $('#programCard').val("<c:out value="${cardPairing.programCard}"/>");
