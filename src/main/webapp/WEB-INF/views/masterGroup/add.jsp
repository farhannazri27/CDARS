            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_group_form" class="form-horizontal" role="form" action="${contextPath}/admin/masterGroup/save" method="post">
                            <div class="form-group">
                                <label for="group" class="col-lg-4 control-label">Group *</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="group" name="group" placeholder="group" value="${group}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="hardware" class="col-lg-4 control-label">Hardware *</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="hardware" name="hardware" placeholder="hardware" value="${hardware}">
                                </div>
                            </div>
                            <div class="form-group">
