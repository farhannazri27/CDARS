                                ...
                                <div class="col-lg-5">                                      
                                    <select id="equipmentId" name="equipmentId" class="js-example-basic-single" style="width: 100%">
                                        ...
                                        <c:forEach items="${eqptIdList}" var="group">
                                            <option value="${group.equipmentId}" ${group.selected}>${group.equipmentId2}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <c:forEach items="${retrieveQueryList}" var="whRetrieve" varStatus="whRetrieveLoop">
                                        <tr>
                                            ...
                                            <c:choose>
                                                <c:when test="${whRetrieve.equipmentType == 'Load Card'}">
                                                    <td><c:out value="${whRetrieve.loadCard}"/></td>
                                                </c:when>
                                                <c:when test="${whRetrieve.equipmentType == 'Program Card'}">
                                                    <td><c:out value="${whRetrieve.programCard}"/></td>
                                                </c:when>
                                                <c:when test="${whRetrieve.equipmentType == 'Load Card & Program Card'}">
                                                    <td><c:out value="${whRetrieve.loadCard}"/><br><c:out value="${whRetrieve.programCard}"/></td>
                                                    </c:when>
                                                    <c:otherwise>
