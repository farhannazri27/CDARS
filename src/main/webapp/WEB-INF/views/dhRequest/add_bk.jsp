                ...
                <div class="col-lg-9">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/wh/whRequest/save" method="post">
                            ...
                            <div class="form-group">
                                <label for="test" class="col-lg-2 control-label">Reason for Retrieval</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="test" name="test" value="${retrievalReason1}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="test1" class="col-lg-2 control-label">Request Type</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="test1" name="test1" value="${requestType1}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="test2" class="col-lg-2 control-label">Equipment Type</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="test2" name="test2" value="${equipmentType1}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <a href="${contextPath}/wh/whRequest/request" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
