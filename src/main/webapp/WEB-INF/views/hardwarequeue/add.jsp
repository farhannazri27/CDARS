...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Add Hardware Queue</h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        <h2>Hardware Queue Information</h2>
                        <form id="add_hardwarequeue_form" class="form-horizontal" role="form" action="${contextPath}/relLab/hardwarequeue/save" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="groupId" name="groupId" class="form-control">
                                        ...
                                        <c:forEach items="${detailsList}" var="group">
