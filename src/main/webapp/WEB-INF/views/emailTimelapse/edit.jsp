            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/whTimelapse/emailTimelapse/update" method="post">
                            ...
                            <a href="${contextPath}/whTimelapse/emailTimelapse" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
