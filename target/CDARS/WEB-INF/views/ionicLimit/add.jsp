...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Add Ionic Test Limit</h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        <h2>Ionic Test Limit Information</h2>
                        <form id="add_hardwarequeue_form" class="form-horizontal" role="form" action="${contextPath}/admin/ionicLimit/save" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <!--<input type="number" class="form-control" id="value" name="value" placeholder="Value Limit" ng-model="myDecimal" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" step="0.01" value="${ionicLimit.value}">-->
